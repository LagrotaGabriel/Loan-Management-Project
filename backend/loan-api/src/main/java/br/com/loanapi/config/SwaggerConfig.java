...
public class SwaggerConfig {
    ...
    public Docket productApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.loanapi"))
                .paths(regex("/api.*"))
                .build()
                .apiInfo(metaInfo());
    }
    ...
    private ApiInfo metaInfo(){
        return new ApiInfo(
                "Loan project - CRUD",
                "Api rest that aims to establish the loan project crud",
                "1.0.0",
                "Terms of Service",
                new Contact("Gabriel Lagrota",
                        "https://github.com/LagrotaGabriel/Loan-Project",
