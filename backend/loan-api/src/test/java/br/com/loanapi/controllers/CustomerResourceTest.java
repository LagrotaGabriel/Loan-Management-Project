...
class CustomerResourceTest {
    ...
    void shouldTestCreateEndPoint() throws ParseException {
        ...
        Assertions.assertEquals("<200 OK OK,CustomerDTO(id=1, name=João, lastName=da Silva, " +
                ...
                "customer=null), phones=null, loans=null),[]>", resource.create(CustomerDTODataBuilder.builder()
                .build()).toString());
    }
    ...
    void shouldTestFindById() throws ParseException {
        ...
        Assertions.assertEquals("<200 OK OK,CustomerDTO(id=1, name=João, lastName=da Silva, " +
                ...
                "neighborhood=Lauzane Paulista, number=583, postalCode=02442-090, city=CityDTO(id=1, city=São Paulo, " +
                "state=SAO_PAULO, addresses=null), customers=null), score=ScoreDTO(id=1, pontuation=50.0, " +
                "customer=null), phones=null, loans=null),[]>", resource.findById(1L).toString());
    }
    ...
    void shouldTestUpdate() throws ParseException {
        ...
        Assertions.assertEquals("<200 OK OK,CustomerDTO(id=1, name=João, lastName=da Silva, " +
                ...
                "neighborhood=Lauzane Paulista, number=583, postalCode=02442-090, city=CityDTO(id=1, city=São Paulo, " +
                "state=SAO_PAULO, addresses=null), customers=null), score=ScoreDTO(id=1, pontuation=50.0, " +
                "customer=null), phones=null, loans=null),[]>", resource.update(CustomerDTODataBuilder.builder().build(), 1L).toString());
    }
