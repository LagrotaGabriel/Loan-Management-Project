...
class ScoreResourceTest {
    ...
    void shouldTestCreateEndPoint() throws ParseException {
        ...
        Assertions.assertEquals("<200 OK OK,ScoreDTO(id=1, pontuation=50.0, customer=CustomerDTO(" +
                        "id=1, name=João, lastName=da Silva, birthDate=Fri Nov 11 00:00:00 BRST 2011, " +
